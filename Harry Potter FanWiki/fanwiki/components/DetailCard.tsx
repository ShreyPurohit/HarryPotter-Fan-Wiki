...
const DetailCard: React.FC<CharacterCardProps> = ({ character }) => {
    return (
        <div className="flex flex-col xl:pt-14 pt-24 sm:pt-20 p-1 sm:h-full md:mb-8 xl:gap-4">
            ...
            <div className="sm:flex sm:justify-evenly ml-2 text-2xl md:justify-around text-center sm:text-left">
